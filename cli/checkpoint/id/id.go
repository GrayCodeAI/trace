...
// It's used to link code commits to metadata on the trace/checkpoints/v1 branch.
//
...
// Path returns the sharded path for this checkpoint ID on trace/checkpoints/v1.
