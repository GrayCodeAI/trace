...
type (
	restoredSessionStartPrompt    func(context.Context, []strategy.RestoredSession) (bool, error)
	restoredSessionPicker         func(context.Context, io.Writer, []strategy.RestoredSession) (strategy.RestoredSession, bool, error)
	restoredSessionLauncher       func(context.Context, io.Writer, strategy.RestoredSession) error
	restoredSessionDisplayer      func(io.Writer, []strategy.RestoredSession) error
	restoredSessionSummaryPrinter func(io.Writer, []strategy.RestoredSession)
)
