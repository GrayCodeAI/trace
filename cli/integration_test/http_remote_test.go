...
// Trace, then switches origin to the HTTPS URL.
...
// checkpoint branch to an HTTPS remote when TRACE_CHECKPOINT_TOKEN is set.
// This exercises:
...
// TRACE_CHECKPOINT_TOKEN makes the push succeed.
