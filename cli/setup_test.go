...
func TestCleanRemoteURLForReport(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			rawURL: "https://github.com/GrayCodeAI/trace.git",
			want:   "https://github.com/GrayCodeAI/trace.git",
		},
		{
			name:   "https token credentials are stripped",
			rawURL: "https://ghp_secrettoken@github.com/GrayCodeAI/trace.git",
			want:   "https://github.com/GrayCodeAI/trace.git",
		},
		{
			name:   "https user:password credentials are stripped",
			rawURL: "https://x-access-token:ghp_secret@github.com/GrayCodeAI/trace.git",
			want:   "https://github.com/GrayCodeAI/trace.git",
		},
		{
			name:   "query parameters are dropped",
			rawURL: "https://github.com/GrayCodeAI/trace.git?token=secret",
			want:   "https://github.com/GrayCodeAI/trace.git",
		},
		{
		...
		},
		{
			...
			rawURL: "https://github.com/GrayCodeAI/trace",
			want:   "https://github.com/GrayCodeAI/trace.git",
		},
		{
