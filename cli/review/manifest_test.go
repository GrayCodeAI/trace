...
const (
	...
	manifestTokenTestAgentName agenttypes.AgentName = "review-token-test"
	manifestTokenTestAgentType agenttypes.AgentType = "Review Token Test"
	manifestFindingsFlag                            = "--findings"
	manifestTestFinding                             = "finding"
)
