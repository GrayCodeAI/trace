...
// ReadFile reads a file from the repo directory and returns its contents.
...
// EnvGitHermetic specifies that, when set to a non-empty value, gitEmptyConfigPath appends
