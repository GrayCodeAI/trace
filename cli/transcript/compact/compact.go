...
// segmenters must tolerate this bounded head overlap.
...
// convention does not matter for FullWithBoundary as long as it is applied
// uniformly to both the full and delta outputs (the boundary is their difference).
