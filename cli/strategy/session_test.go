...
func TestListSessionsEmptyRepo(t *testing.T) {
	...
	// No trace/checkpoints/v1 branch exists yet
...
func TestListSessionsWithCheckpoints(t *testing.T) {
	...
	// Create trace/checkpoints/v1 branch with test checkpoints
...
func TestListSessionsWithDescription(t *testing.T) {
	...
	// Create trace/checkpoints/v1 branch with test checkpoint including prompt.txt
