...
func runOpenCodeExportToFile(ctx context.Context, sessionID, outputPath string) (retErr error) {
	...
	//nolint:gosec // outputPath is generated by the caller under .trace/tmp
	file, err := os.OpenFile(outputPath, os.O_CREATE|os.O_WRONLY|os.O_TRUNC, 0o600) // #nosec G304 -- outputPath is generated by the caller under .trace/tmp, not external input
	if err != nil {
