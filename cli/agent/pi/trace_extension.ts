// Trace CLI extension for Pi
// Auto-generated by `trace enable --agent pi`
// Do not edit manually — changes will be overwritten on next install.
//
// Forwards Pi lifecycle events to `trace hooks pi <event>` so Trace can
// create checkpoints, capture transcripts, and offer rewind/resume.
//
// TRACE_CMD is replaced at install time by Entire's installer.
...
export default function (pi: ExtensionAPI) {
  ...
  // Trace treats agent-driven commits as non-interactive.
