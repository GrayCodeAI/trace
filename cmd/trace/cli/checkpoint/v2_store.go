...
// It writes to two custom refs under refs/trace/:
...
type V2GitStore struct {
	...
	// fetching /full/* refs during trace resume). Defaults to "origin".
...
// /full/* refs during trace resume). Pass "origin" or the checkpoint remote URL.
