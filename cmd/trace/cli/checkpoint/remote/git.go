...
const CheckpointTokenEnvVar = "TRACE_CHECKPOINT_TOKEN"
...
// checkpoint token authentication. If TRACE_CHECKPOINT_TOKEN is set:
...
//
// This is only meaningful when TRACE_CHECKPOINT_TOKEN is set; callers gate on
// that themselves.
