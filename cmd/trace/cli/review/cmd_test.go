...
// TestReviewCmd_Help verifies `trace review --help` contains the expected
...
// TestRunReview_MissingHooksAborts verifies that `trace review` aborts with a
