...
func (s *stubReviewer) Start(_ context.Context, _ reviewtypes.RunConfig) (reviewtypes.Process, error) { //nolint:ireturn // interface required by contract
	if s.startErr != nil {
...
func (r *funcReviewer) Start(_ context.Context, _ reviewtypes.RunConfig) (reviewtypes.Process, error) { //nolint:ireturn // interface required by contract
