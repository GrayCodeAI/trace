...
import (
	...
	checkpointID "github.com/GrayCodeAI/trace/cmd/trace/cli/checkpoint/id"
)
...
func TestIsTrailerLine(t *testing.T) {
	...
	tests := []struct {
		...
		{"Trace-Checkpoint: abc123def456", true},
		{"not a trailer", false},
...
func TestFormatMetadata(t *testing.T) {
	...
	metadataDir := ".trace/metadata/2025-01-28-abc123"
...
func TestParseMetadata(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantDir:   ".trace/metadata/2025-01-28-abc123",
			wantFound: true,
		},
		{
			name:      "no trailer",
...
func TestFormatTaskMetadata(t *testing.T) {
	...
	taskMetadataDir := ".trace/metadata/2025-01-28-abc123/tasks/toolu_xyz"
...
func TestParseTaskMetadata(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantDir:   ".trace/metadata/2025-01-28-abc/tasks/toolu_123",
			wantFound: true,
		},
		{
