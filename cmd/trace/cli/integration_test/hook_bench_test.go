...
import (
	...
	"github.com/GrayCodeAI/trace/cmd/trace/cli/benchutil"
...
// Run all:
//
//	go test -tags=integration -bench=BenchmarkHookSessionStart -benchtime=3x -run='^$' -timeout=10m ./cmd/trace/cli/integration_test/...
//
// Run one dimension:
//
//	go test -tags=integration -bench=BenchmarkHookSessionStart/Subprocess -benchtime=5x -run='^$' ./cmd/trace/cli/integration_test/...
