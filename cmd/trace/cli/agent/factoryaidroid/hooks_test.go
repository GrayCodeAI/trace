...
func TestInstallHooks_FreshInstall(t *testing.T) {
	...
	assertFactoryHookExists(t, settings.Hooks.SessionStart, "", agentpkg.WrapProductionSilentHookCommand("trace hooks factoryai-droid session-start"), "SessionStart")
	assertFactoryHookExists(t, settings.Hooks.SessionStart, "", agentpkg.WrapProductionSilentHookCommand("trace hooks factoryai-droid user-prompt-submit"), "SessionStart user-prompt-submit")
	assertFactoryHookExists(t, settings.Hooks.SessionEnd, "", agentpkg.WrapProductionSilentHookCommand("trace hooks factoryai-droid session-end"), "SessionEnd")
	assertFactoryHookExists(t, settings.Hooks.Stop, "", agentpkg.WrapProductionPlainTextWarningHookCommand("trace hooks factoryai-droid stop", agentpkg.WarningFormatSingleLine), "Stop")
	assertFactoryHookExists(t, settings.Hooks.UserPromptSubmit, "", agentpkg.WrapProductionSilentHookCommand("trace hooks factoryai-droid user-prompt-submit"), "UserPromptSubmit")
	assertFactoryHookExists(t, settings.Hooks.PreToolUse, "Task", agentpkg.WrapProductionSilentHookCommand("trace hooks factoryai-droid pre-tool-use"), "PreToolUse[Task]")
	assertFactoryHookExists(t, settings.Hooks.PostToolUse, "Task", agentpkg.WrapProductionSilentHookCommand("trace hooks factoryai-droid post-tool-use"), "PostToolUse[Task]")
	assertFactoryHookExists(t, settings.Hooks.PreCompact, "", agentpkg.WrapProductionSilentHookCommand("trace hooks factoryai-droid pre-compact"), "PreCompact")
...
func TestInstallHooks_LocalDev(t *testing.T) {
	...
	prefix := `go run "$(git rev-parse --show-toplevel)"/cmd/trace/main.go hooks factoryai-droid `
...
func TestInstallHooks_PreservesUserHooksOnSameType(t *testing.T) {
  ...
  "hooks": {
	...
	t.Run("Stop", func(t *testing.T) {
		...
		assertFactoryHookExists(t, matchers, "", agentpkg.WrapProductionPlainTextWarningHookCommand("trace hooks factoryai-droid stop", agentpkg.WarningFormatSingleLine), "Trace Stop hook")
	})
	...
	t.Run("SessionStart", func(t *testing.T) {
		...
		assertFactoryHookExists(t, matchers, "", agentpkg.WrapProductionSilentHookCommand("trace hooks factoryai-droid session-start"), "Trace SessionStart hook")
		assertFactoryHookExists(t, matchers, "", agentpkg.WrapProductionSilentHookCommand("trace hooks factoryai-droid user-prompt-submit"), "Trace SessionStart user-prompt-submit hook")
	})
	...
	t.Run("PostToolUse", func(t *testing.T) {
		...
		assertFactoryHookExists(t, matchers, "Task", agentpkg.WrapProductionSilentHookCommand("trace hooks factoryai-droid post-tool-use"), "Trace Task hook")
	})
}
