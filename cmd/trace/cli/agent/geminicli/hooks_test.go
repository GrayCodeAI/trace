...
func TestInstallHooks_FreshInstall(t *testing.T) {
	...
	verifyHookCommand(t, settings.Hooks.SessionStart, "", agentpkg.WrapProductionJSONWarningHookCommand("trace hooks gemini session-start", agentpkg.WarningFormatSingleLine))
	verifyHookCommand(t, settings.Hooks.SessionEnd, "exit", agentpkg.WrapProductionSilentHookCommand("trace hooks gemini session-end"))
	verifyHookCommand(t, settings.Hooks.SessionEnd, "logout", agentpkg.WrapProductionSilentHookCommand("trace hooks gemini session-end"))
	verifyHookCommand(t, settings.Hooks.BeforeAgent, "", agentpkg.WrapProductionSilentHookCommand("trace hooks gemini before-agent"))
	verifyHookCommand(t, settings.Hooks.AfterAgent, "", agentpkg.WrapProductionSilentHookCommand("trace hooks gemini after-agent"))
	verifyHookCommand(t, settings.Hooks.BeforeModel, "", agentpkg.WrapProductionSilentHookCommand("trace hooks gemini before-model"))
	verifyHookCommand(t, settings.Hooks.AfterModel, "", agentpkg.WrapProductionSilentHookCommand("trace hooks gemini after-model"))
	verifyHookCommand(t, settings.Hooks.BeforeToolSelection, "", agentpkg.WrapProductionSilentHookCommand("trace hooks gemini before-tool-selection"))
	verifyHookCommand(t, settings.Hooks.BeforeTool, "*", agentpkg.WrapProductionSilentHookCommand("trace hooks gemini before-tool"))
	verifyHookCommand(t, settings.Hooks.AfterTool, "*", agentpkg.WrapProductionSilentHookCommand("trace hooks gemini after-tool"))
	verifyHookCommand(t, settings.Hooks.PreCompress, "", agentpkg.WrapProductionSilentHookCommand("trace hooks gemini pre-compress"))
	verifyHookCommand(t, settings.Hooks.Notification, "", agentpkg.WrapProductionSilentHookCommand("trace hooks gemini notification"))
}
...
func TestInstallHooks_LocalDev(t *testing.T) {
	...
	prefix := `go run "$(git rev-parse --show-toplevel)"/cmd/trace/main.go hooks gemini `
...
}`, agentpkg.WrapProductionJSONWarningHookCommand("trace hooks gemini session-start", agentpkg.WarningFormatSingleLine)))
