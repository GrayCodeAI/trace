...
// traceHookPrefixes are command prefixes that identify Trace hooks (both old and new formats)
...
func (c *ClaudeCodeAgent) InstallHooks(ctx context.Context, localDev bool, force bool) (int, error) {
	...
	if localDev {
		sessionStartCmd = "go run ${CLAUDE_PROJECT_DIR}/cmd/trace/main.go hooks claude-code session-start"
		sessionEndCmd = "go run ${CLAUDE_PROJECT_DIR}/cmd/trace/main.go hooks claude-code session-end"
		stopCmd = "go run ${CLAUDE_PROJECT_DIR}/cmd/trace/main.go hooks claude-code stop"
		userPromptSubmitCmd = "go run ${CLAUDE_PROJECT_DIR}/cmd/trace/main.go hooks claude-code user-prompt-submit"
		preTaskCmd = "go run ${CLAUDE_PROJECT_DIR}/cmd/trace/main.go hooks claude-code pre-task"
		postTaskCmd = "go run ${CLAUDE_PROJECT_DIR}/cmd/trace/main.go hooks claude-code post-task"
		postTodoCmd = "go run ${CLAUDE_PROJECT_DIR}/cmd/trace/main.go hooks claude-code post-todo"
	} else {
