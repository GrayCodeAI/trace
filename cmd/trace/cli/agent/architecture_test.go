...
func TestAgentPackages_NoForbiddenImports(t *testing.T) {
	...
	const repoPrefix = "github.com/GrayCodeAI/trace/cmd/trace/cli/"
	...
	forbiddenCLIPackage := repoPrefix[:len(repoPrefix)-1] // "github.com/GrayCodeAI/trace/cmd/trace/cli"
...
// findAgentDir returns the absolute path to cmd/trace/cli/agent/.
