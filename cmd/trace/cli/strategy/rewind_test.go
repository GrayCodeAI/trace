...
import (
	...
	_ "github.com/GrayCodeAI/trace/cmd/trace/cli/agent/claudecode" // Register agent for ResolveAgentForRewind tests
	_ "github.com/GrayCodeAI/trace/cmd/trace/cli/agent/geminicli"  // Register agent for ResolveAgentForRewind tests
