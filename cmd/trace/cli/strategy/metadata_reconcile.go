...
import (
	...
	remote "github.com/GrayCodeAI/trace/cmd/trace/cli/checkpoint/remote"
...
// trace/checkpoints/v1 branches. Disconnected means no common ancestor, which
...
// Uses the refs/trace-fetch-tmp/ namespace consistent with checkpoint_remote.go.
const v2DoctorTmpRef = "refs/trace-fetch-tmp/doctor-v2-main"
...
func ReconcileDisconnectedV2Ref(
	...
	fmt.Fprintln(w, "[trace] Detected disconnected v2 /main refs (local and remote share no common ancestor)")
