...
//
// Run: go test -v -run TestCommitHookPerformance -tags hookperf -timeout 15m ./cmd/trace/cli/strategy/
...
var perfFileSets = [][]string{
	{"main.go", "go.mod"},
	{"cmd/trace/main.go", "cmd/trace/cli/root.go"},
	{"go.sum", "README.md", "Makefile"},
	{"cmd/trace/cli/strategy/common.go"},
	{"cmd/trace/cli/session/state.go", "cmd/trace/cli/session/phase.go"},
	{"cmd/trace/cli/paths/paths.go", "cmd/trace/cli/paths/worktree.go", "go.mod"},
	{"cmd/trace/cli/agent/claude.go"},
...
var perfLargeFileSets = func() [][]string {
	dirs := []string{
		"cmd/trace/cli/strategy",
		"cmd/trace/cli/session",
		"cmd/trace/cli/checkpoint",
		"cmd/trace/cli/agent/claudecode",
		"cmd/trace/cli/agent/geminicli",
		"cmd/trace/cli/paths",
		"cmd/trace/cli/logging",
		"cmd/trace/cli/settings",
		"cmd/trace/cli",
		"docs/architecture",
	}
	var sets [][]string
