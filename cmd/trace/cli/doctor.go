...
Checks performed:
  ...
  2. Disconnected v2 /main ref: same detection for v2 refs under refs/trace/.
...
func checkDisconnectedMetadata(cmd *cobra.Command, force bool) error {
	...
	fmt.Fprintln(w, "  Local and remote trace/checkpoints/v1 branches share no common ancestor.")
