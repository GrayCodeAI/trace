...
func TestIsSubpath(t *testing.T) {
	tests := []struct {
		...
		// Relative paths
		{name: "relative child inside", parent: ".trace", child: ".trace/metadata/test", want: true},
		{name: "relative equal", parent: ".trace", child: ".trace", want: true},
		{name: "relative outside", parent: ".trace", child: "src/main.go", want: false},
		{name: "relative prefix not subpath", parent: ".trace", child: ".tracefile", want: false},
...
func TestGetClaudeProjectDir_Override(t *testing.T) {
	...
	t.Setenv("TRACE_TEST_CLAUDE_PROJECT_DIR", "/tmp/test-claude-project")
...
func TestGetClaudeProjectDir_Default(t *testing.T) {
	...
	t.Setenv("TRACE_TEST_CLAUDE_PROJECT_DIR", "")
