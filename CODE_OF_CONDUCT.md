...
This Code of Conduct applies to all Trace community spaces, including:

- **GitHub** - repositories, issues, pull requests, discussions, and comments
- **Discord** - all channels in the Trace workspace
- **Events** - meetups, conferences, and online gatherings hosted by Trace
- **Public representation** - acting as a representative of Trace in public spaces, including social media, forums, and conferences
...
To report a Code of Conduct violation, contact **[conduct@trace.io](mailto:conduct@trace.io)**.

For security vulnerabilities, please email **[security@trace.io](mailto:security@trace.io)** instead. See our [Security Policy](SECURITY.md).
