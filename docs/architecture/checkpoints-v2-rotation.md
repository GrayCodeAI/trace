...
```text
refs/trace/checkpoints/v2/main
refs/trace/checkpoints/v2/full/current
refs/trace/checkpoints/v2/full/0000000000001
refs/trace/checkpoints/v2/full/0000000000002
```
...
```text
<git-common-dir>/trace-v2-rotations/pending.json
<git-common-dir>/trace-v2-rotations/pending.lock
```
...
```json
{
  "archive_ref_name": "refs/trace/checkpoints/v2/full/0000000000007",
