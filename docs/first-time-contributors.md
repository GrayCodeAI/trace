...
Click **Fork** on [github.com/GrayCodeAI/trace](https://github.com/GrayCodeAI/trace). This creates a copy under your account that you have write access to.
...
### `trace` command not found after build
